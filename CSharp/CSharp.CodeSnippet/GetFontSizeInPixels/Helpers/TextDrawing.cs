...
namespace GetFontSizeInPixels.Helpers
{
    public static class TextDrawing
    {
        ...
        public static void SetGraphicsHighQualityForTextRendering(Graphics g)
        {
        ...
        public static Size MeasureDrawTextSize(string text, Font font, Control control = null)
        {
        ...
        public static int GetMaximumFontSizeFitInRectangle(string text, Font font, RectangleF rectanglef, bool isWarp, int MinumumFontSize = 2, int MaximumFontSize = 1000)
        {
            Font newFont;
