...
namespace SelfHostedWebApi.Data.Accessors
{
    public class SqlServerAccessor : IDBAccessor
    {
        #region Constructor
        ...
        public SqlServerAccessor(IConfigurationProvider configurationProvider): this("SqlServerConnection", configurationProvider)
        {
        }
        ...
        /// <param name="configurationProvider"></param>
        public SqlServerAccessor(string connectionName, IConfigurationProvider configurationProvider)
        {
            ...
            this._connection = new SqlConnection(_configurationProvider.GetConnectionString(_connectionName));
        }
        ...
        {
            get { return string.Format("{0}@{1}", this._connection.Database, this.DataSource); }
        }
