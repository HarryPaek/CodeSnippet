...
namespace ePlatform.Data.Accessors
{
    public class OracleAccessor : IDBAccessor
    {
        ...
        public OracleAccessor(IConfigurationProvider configurationProvider) : this("OracleConnection", configurationProvider)
        {
        }
        ...
        /// <param name="configurationProvider"></param>
        public OracleAccessor(string connectionName, IConfigurationProvider configurationProvider)
        {
